        ...
        return (
            <div>
                 <div className = "row mt-4">
                    <button className="btn btn-primary pt-2 pb-2 float-right" onClick={this.addEmployee}><BsFillPlusCircleFill/>  Bill </button>
                 </div>
                 <br></br>
                        ...
                        <table className = "table table-bordered">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th className='text-center'> Flavor</th>
